...
#define SHKMyAppName			@"SP BUZZ"
#define SHKMyAppURL				@"http://itunes.apple.com/sg/app/sp-buzz/id412682070?mt=8"
 ...
 */
#define SHKTwitterConsumerKey		@"5sQVx7oVW1ZtXgzohZOSQ"
#define SHKTwitterSecret			@"YeMGDzW7CJ28gfX1wlyY1PzpNrO1A8i8lJSWL2WUPI"
#define SHKTwitterCallbackUrl		@"http://www.sp.edu.sg" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"o_320o7srcdg"
#define SHKBitLyKey					@"R_c75f24fe36147285697d0acf83ae6c71"
